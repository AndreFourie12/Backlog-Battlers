...
// the names the search screen writes on its chips.
// the domain enums stay free of resource ids, the mapping lives here with the
// rest of the ui helpers


// the label on a "Browse by genre" chip
@StringRes
...
// the label on the Sort chip once a choice has been made
@StringRes
